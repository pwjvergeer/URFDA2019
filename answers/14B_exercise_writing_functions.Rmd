...
# step 4: 
 ...
 set.seed(1234)
test_numeric <- c(rnorm(100), NA, NA)


calculate_mean(numeric_vector = test_numeric, na.rm = TRUE)
...
Write a short roxygen documentation on the function `calculate_mean()` above. 
Use at least a function title, define the arguments for the function and write what the function returns. For more details on Roxygen, see: http://r-pkgs.had.co.nz/man.html

```{r}

#' @title Calculate the mean over a numeric vector
#' @param numeric_vector Any vector of class numeric or coercible to one
#' @param ... Addiontional argument passed to function mean()
...
1C) Build onto the function created at 1A: The function has to return the mean and has to state whether the input is an integer, a numeric  or a logical vector. 
