...
```{r}
path <- here("labs", "09_lab_import_data", "one", "two", "here_here.txt")
readLines(path)
```
...
## This is a copy of the blogpost of Jenny Bryan: the original text is found here ;-0 : https://github.com/jennybc/here_here 
