...
## Derive from the OSS lesson repo on github: "SQL Database Access in R" https://github.com/NCEAS/oss-lessons

## Introduction

Here we're going to learn how to work with SQL databases in R.

1. Directly executing SQL statements against a database from R
2. Using `dplyr` ability to work with SQL databases
...
dbWriteTable(con, "starwars", dplyr::select(starwars, -films, -vehicles, -starships))
...
## You can also connect to other types of databases: See https://cran.r-project.org/web/packages/dbplyr/vignettes/dbplyr.html for more info